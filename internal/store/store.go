...
func (s *Store) migrate() error {
	...
	if _, err = s.db.Exec(`INSERT OR IGNORE INTO schema_migrations(version) VALUES(16),(17)`); err != nil {
		return err
	}
	return s.migrateStandaloneInventoryV18()
}
...
INSERT OR IGNORE INTO launchers(slug,name,adapter) VALUES('steam','Steam','steam'),('ea-app','EA App','ea_app'),('ubisoft-connect','Ubisoft Connect','ubisoft_connect'),('standalone','Ohne Launcher','standalone');
